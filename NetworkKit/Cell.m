...
- (void)awakeFromNib {
    ...
    CGFloat itemWidth = (cellWidth / 4.0);
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-2.0-[one(w)]-2.0-[two(w)]-2.0-[three(w)][four(w)]-2.0-|" options:NSLayoutFormatAlignAllTop | NSLayoutFormatAlignAllBottom metrics:metrics views:views]];
}
